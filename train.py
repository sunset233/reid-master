...
from misc import AverageMeter, Logger, set_seed
...
for epoch in range(start_epoch, 81 - start_epoch):
    ...
    trainloader = data.DataLoader(trainset, batch_size=args.batch_size * args.num_pos, sampler=sampler, num_workers=args.workers, drop_last=True)
